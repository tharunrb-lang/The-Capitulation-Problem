...
## 🛠️ Methodology
1. **Model:** Gemma 4B (Local via Ollama).
2. **Baseline:** C6 Neutral System Prompt.
3. **Domains:** Factual, Moral, Emotional, Speculative Scientific, and Legal-Ethical.
4. **Analysis:** Rule-based classification validated against Human-as-Judge metrics.

## ⚖️ The Three-Question Diagnostic
The research proposes a framework to stop capitulation:
1. **Origin Check:** Is the output from knowledge or anxiety?
2. **Pressure Audit:** Is this new information or just social friction?
3. **Specificity Test:** Can you name exactly what fact changed?
